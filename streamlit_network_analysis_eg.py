...
# cd /Users/dreameshuggah/Documents/Rizal_Analytics/Network_Analysis/StreamlitApp
...
st.dataframe(df[['from','to','label','weight']].rename(columns={'label':'relationship','weight':'n_games_played'}))
